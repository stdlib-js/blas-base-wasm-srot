...
// Attached to the main export is a `main` method which returns a Float32Array...
{
	...
	srot.main( x.length, x, 1, y, 1, 1.0, 0.0 ); // $ExpectType Float32Array
}
...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	srot.main( '10', x, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( true, x, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( false, x, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( null, x, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( undefined, x, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( [], x, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( {}, x, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( ( x: number ): number => x, x, 1, y, 1, 1.0, 0.0 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a second argument which is not a Float32Array...
{
	...
	srot.main( x.length, 10, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, '10', 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, true, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, false, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, null, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, undefined, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, [], 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, {}, 1, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, ( x: number ): number => x, 1, y, 1, 1.0, 0.0 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a third argument which is not a number...
{
	...
	srot.main( x.length, x, '10', y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, true, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, false, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, null, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, undefined, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, [], y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, {}, y, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, ( x: number ): number => x, y, 1, 1.0, 0.0 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fourth argument which is not a Float32Array...
{
	...
	srot.main( x.length, x, 1, 10, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, '10', 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, true, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, false, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, null, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, undefined, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, [], 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, {}, 1, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, ( x: number ): number => x, 1, 1.0, 0.0 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fifth argument which is not a number...
{
	...
	srot.main( x.length, x, 1, y, '10', 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, true, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, false, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, null, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, undefined, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, [], 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, {}, 1.0, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, ( x: number ): number => x, 1.0, 0.0 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a sixth argument which is not a number...
{
	...
	srot.main( x.length, x, 1, y, 1, '10', 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, true, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, false, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, null, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, undefined, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, [], 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, {}, 0.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, ( x: number ): number => x, 0.0 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a seventh argument which is not a number...
{
	...
	srot.main( x.length, x, 1, y, 1, 1.0, '10' ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, 1.0, true ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, 1.0, false ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, 1.0, null ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, 1.0, undefined ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, 1.0, [] ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, 1.0, {} ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, 1.0, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided an unsupported number of arguments...
{
	...
	srot.main(); // $ExpectError
	srot.main( x.length ); // $ExpectError
	srot.main( x.length, x ); // $ExpectError
	srot.main( x.length, x, 1 ); // $ExpectError
	srot.main( x.length, x, 1, y ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, 1.0 ); // $ExpectError
	srot.main( x.length, x, 1, y, 1, 1.0, 0.0, 10 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided an eighth argument which is not a number...
{
	...
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, '10', 0.0 ); // $ExpectError
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, true, 0.0 ); // $ExpectError
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, false, 0.0 ); // $ExpectError
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, null, 0.0 ); // $ExpectError
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, undefined, 0.0 ); // $ExpectError
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, [], 0.0 ); // $ExpectError
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, {}, 0.0 ); // $ExpectError
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, ( x: number ): number => x, 0.0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a ninth argument which is not a number...
{
	...
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, 1.0, '10' ); // $ExpectError
...
// The compiler throws an error if the `ndarray` method is provided an unsupported number of arguments...
{
	...
	srot.ndarray( x.length, x, 1, 0, y, 1 ); // $ExpectError
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, 1.0 ); // $ExpectError
	srot.ndarray( x.length, x, 1, 0, y, 1, 0, 1.0, 0.0, 10 ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	srot.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	srot.Module( '10' ); // $ExpectError
	srot.Module( true ); // $ExpectError
	srot.Module( false ); // $ExpectError
	srot.Module( null ); // $ExpectError
	srot.Module( undefined ); // $ExpectError
	srot.Module( [] ); // $ExpectError
	srot.Module( {} ); // $ExpectError
	srot.Module( ( x: number ): number => x ); // $ExpectError
}
